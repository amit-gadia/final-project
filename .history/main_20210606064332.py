...
class add_roles:
    ...
    def add_role():
        ...
        if(role=="Warden"):
            ...
            return render_template("tome.html",text="Placement Role User Successfully",id=1)
        elif(role=="Accounts"):
            return render_template("tome.html",text="Accounts Role User Successfully",id=1)
        elif(role=="Transport"):
            return render_template("tome.html",text="Transport Role User Successfully",id=1)
        elif(role=="Library"):
            return render_template("tome.html",text="Library Role User Successfully",id=1)
        elif(role=="Faculty"):
            return render_template("tome.html",text="Faculty Role User Successfully",id=1)
